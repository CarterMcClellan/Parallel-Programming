#!/usr/bin/env python3
"""
Auto-tune atomic_add candidate: Test all BLOCK_SIZE values and show performance breakdown
"""
...
def test_kernel(data_flat, block_size):
    ...
    output_tensor = torch.zeros(1, dtype=torch.float64, device=data_flat.device)
    grid = (n_blocks,)
...
def main():
    print("=" * 80)
    print("AUTO-TUNING: atomic_add - BLOCK_SIZE Performance Breakdown")
    print("=" * 80)
